...
shading flat; 
colorbar;
xticks([5,20,35,50,65])
xticklabels({'-30','-15','0','15','30'})
yticks([5,20,35,50,65])
yticklabels({'-30','-15','0','15','30'})
set(gca, 'LineWidth',1,'Fontname', 'Times New Roman','FontSize',25)
xlabel('L','Fontname', 'Times New Roman','FontSize',25)
ylabel('L','Fontname', 'Times New Roman','FontSize',25)

figure()
pcolor(abs(S)); hold on;
colormap(jet(20));
shading flat; 
colorbar;
xticks([5,20,35,50,65])
...
figure()
plot([-1,1],[-1,1],'k-','linewidth',1,'DisplayName','theory');hold on;
scatter(real(Sx),real(Sy),100,'MarkerEdgeColor', color_red,...
              'MarkerFaceColor', ["none"],...
              'LineWidth',1.5,'DisplayName','Real(S)');hold on;
scatter(imag(Sx),imag(Sy),100,'MarkerEdgeColor', color_blue,...
              'MarkerFaceColor', ["none"],...
              'LineWidth',1.5,'DisplayName','Img(S)');hold on
