...
% load('edgeModeData.mat')
% load('edgeStateEccentric.mat')
load('chaoticScatteringStateEccentric.mat')
...
N=500;
x_choose=linspace(-1.1,1.1,N);
y_choose=linspace(-1.1,1.1,N);
...
save dataProbDensChaoticStateAndError

% figure()
% pcolor(xx, yy,  error); hold on;
% colormap(jet(20));
% plot(real(Zj1), imag(Zj1), 'w-');hold on
% plot(real(Zj2), imag(Zj2), 'w-');hold on
% shading flat; 
